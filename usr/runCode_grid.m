...
range_log_volume_km3 = linspace(1,2,3);  % range of log volume in km3

% volatile content
range_water      = linspace(0.5,6,1); % h2o content (wt%)
range_co2        = linspace(100,1000,1); % co2 content (ppm)

% recharge rate (km3/yr) -- note: enter the LOG of recharge rate
range_log_vfr    = linspace(-5,-4,2); % log volume recharge rate (km3/yr)
...
for run_i = 1:number_runs
    
    run_n       = run_i;     % Number for input/output files
